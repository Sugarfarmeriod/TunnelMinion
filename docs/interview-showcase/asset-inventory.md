...
| `product-surface-review` | Overview、Chat、Operations、Memories、Settings 对主演示与深挖的承载预审 | `draft-pr-verified` 预审已生成；3.2 未完成 | PR #40 Draft head `61398b76d01b3836dc6023f74b0ba3d17ef7cbb4`；等待合并后重审 | repository / `verify_product_surface_review.py` | `product-surface-review.md` → 合并后产品承载裁决 | 不把端口冒充完整访问地址；不提前规划聚合视图；不得算作稳定 `main` 证据 |
